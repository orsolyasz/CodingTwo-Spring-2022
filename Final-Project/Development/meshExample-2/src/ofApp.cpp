...
//    colorImg.draw(vidGrabber.getWidth()+20,20, -vidGrabber.getWidth(),vidGrabber.getHeight());
    grayImage.draw(vidGrabber.getWidth()+20,20, -vidGrabber.getWidth(),vidGrabber.getHeight());
    ...
    ofPushStyle();
        ...
        ofSetLineWidth(1);
            ...
            for (unsigned int i = 0; i < lAudio.size(); i++){
                ...
                ofVertex(blobcenterX+cos(i*PI*2/512)*2400*(scaledVol+1)*lAudio[i], sin(i*PI*2/512)*2400*(scaledVol+1)*lAudio[i]);
                ofVertex(blobcenterX+cos(i*PI*2/512)*100*lAudio[i], sin(i*PI*2/512)*lAudio[i]);
               // ofVertex(500,500);
